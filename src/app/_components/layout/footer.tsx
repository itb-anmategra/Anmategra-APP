    ...
    <div className="w-full h-full mt-auto px-16 py-8 flex flex-col items-center justify-start border-t-2 border-slate-100 bg-white">
      <div className="h-full w-full flex items-start justify-between gap-x-8">
        <div className="w-full flex flex-col gap-y-2 flex-[2]">
          ...
          <div>
            <h3 className="text-2xl text-Blue-Dark font-semibold my-2">
              Kementerian Riset dan Sistematisasi <br />
              Sumber Daya Manusia
            </h3>
            <p className="text-Blue-Dark leading-5">
              Kemenkoan Pengembangan Sumber Daya Manusia <br /> Kabinet
              “Restorasi marwah” KM ITB 2024/2025
            </p>
          </div>
          <div className="py-2">
            <p className="text-Blue-Dark text-[16px]">
