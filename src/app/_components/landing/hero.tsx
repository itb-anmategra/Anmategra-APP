      ...
      <div className="relative w-full h-screen">
        ...
        <div 
          ...
          style={{
            ...
            backgroundImage: 'linear-gradient(white, white), linear-gradient(180deg, #9ACCEA 0%, #99E5E5 0%, #2488C0 18.5%, #99E5E5 47.21%, #2488C0 72.71%, #99E5E5 100%)',
        ...
        >
          ...
          <div 
            ...
            style={{
              borderRadius: '50%',
              border: '5px solid transparent',
              backgroundImage: 'linear-gradient(white, white), linear-gradient(180deg, rgba(154, 204, 234, 0.00) 0%, rgba(153, 229, 229, 0.00) 0%, rgba(36, 136, 192, 0.13) 18.5%, rgba(153, 229, 229, 0.50) 47.21%, rgba(36, 136, 192, 0.13) 72.71%, rgba(153, 229, 229, 0.00) 100%)',
              backgroundOrigin: 'border-box',
              backgroundClip: 'padding-box, border-box',
              opacity: isCircleVisible ? 1 : 0,
              transform: `translate(-50%, -50%) translateY(${isCircleVisible ? '0px' : '30px'})`,
          ...
          {/* Blue Glow */}
          <div 
            className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[1] ${isMobile ? 'w-[360px] h-[360px]' : 'w-[412px] h-[412px]'}`}
            style={{
              borderRadius: '50%',
              opacity: isCircleVisible ? (isMobile ? 0.6 : 0.45) : 0,
              background: '#06A5FF',
              filter: isMobile ? 'blur(100px)' : 'blur(196.8px)',
              transform: `translate(-50%, -50%) translateY(${isCircleVisible ? '0px' : '30px'})`,
              transition: 'opacity 1s ease-out, transform 1s ease-out'
            }}
          />
          ...
          {/* Text */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[2] w-full">
            <div className="w-full px-6 sm:px-8 lg:px-12">
              <div className="flex flex-col items-center justify-center text-center gap-6 sm:gap-8 lg:gap-10">
                ...
                >
                  Cari kegiatan, lembaga, atau anggota
                  KM ITB yang Anda inginkan sekarang
                </p>
              </div>
            </div>
          </div>
