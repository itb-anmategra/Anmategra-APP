                                    ...
                                    <>
                                        <div className='text-center items-center flex flex-row gap-8'>
                                            ...
                                            <div className='max-w-[400px] text-left'>
                                                <h5 className='text-2xl font-semibold text-slate-600'>Tidak Ada
                                                    Informasi Kepanitiaan</h5>
                                                <p className='text-slate-400 mt-2'>Kami tidak dapat menemukan informasi
                                                    kepanitiaan yang diikuti, silahkan menambahkan jika ada</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className='text-center items-center flex flex-row gap-8'>
                                            ...
                                            <div className='max-w-[400px] text-left'>
                                                <h5 className='text-2xl font-semibold text-slate-600'>Tidak Ada
                                                    Informasi Kepanitiaan</h5>
                                                <p className='text-slate-400 mt-2'>Kami tidak dapat menemukan informasi
                                                    kepanitiaan yang diikuti oleh mahasiswa ini</p>
                                            </div>
                                        </div>
                                    </>
                                )}
