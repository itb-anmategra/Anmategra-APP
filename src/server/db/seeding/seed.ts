...
const TEST_EMAIL = '13524103@std.stei.itb.ac.id'; // Change this to your own private email
const TEST_EMAIL_MAHASISWA = '13524103@mahasiswa.itb.ac.id'; // Change this to your own nim
